#image has chrome , you need to set args: ['--no-sandbox']

# use official images https://github.com/puppeteer/puppeteer/blob/main/docker/Dockerfile
# the puppeteer `s chrome supported Chinese
FROM node
USER root
